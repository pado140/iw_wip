 ...
 * @author Duvers
 */
public class Select_Sku extends javax.swing.JDialog implements Observe{
    ...
    public Select_Sku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void mostrarDatos(){
      ...
      try{
          ...
          String query = "SELECT DISTINCT sku,brand from orderplan WHERE STATUS_147<>'5' and brand='AGA'";
        ...
        //Statement sta = conn.createStatement();
          ResultSet rs = conn.select(query);
           ...
           while (rs.next()){
             tbm.addRow(new Object[]{ rs.getString("sku"),rs.getString("brand")});
    ...
    DefaultTableModel tbm = (DefaultTableModel) grid_po.getModel();
        ...
        String sql =  "select DISTINCT sku,brand from orderplan where sku like ? AND STATUS_147<>5";  //like '%"+buscar+"%'";
    ...
    private void grid_poMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grid_poMouseClicked
        ...
        if (evt.getClickCount() == 2){
            ...
            alerter("sku",grid_po.getModel().getValueAt(selectedrow, 0),grid_po.getModel().getValueAt(selectedrow, 1));
