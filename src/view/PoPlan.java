 ...
 * @author Padovano
 */
public class PoPlan extends javax.swing.JDialog implements Observe{

    private ConnectionDb conn = ConnectionDb.instance(); 
    private Map<String,Set<String>> Po=new HashMap<>();
    
    /**
     * Creates new form PoPlan
     */
    public PoPlan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        txt_po.setText(null);
            mostrarDatos();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_po, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void grid_poMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grid_poMouseClicked
        ...
        if (evt.getClickCount() == 2){
            ...
            alerter("poplan",grid_po.getModel().getValueAt(selectedrow, 0),grid_po.getModel().getValueAt(selectedrow, 1),Po.get(grid_po.getModel().getValueAt(selectedrow, 0)));
    ...
    public void mostrarDatos(){
      ...
      try{
          ...
          String query1 = "SELECT styfam from orderplan WHERE STATUS_147<>'5' and po=?";
        ...
        //Statement sta = conn.createStatement();
          ResultSet rs = conn.select(query);
           ...
           while (rs.next()){
             ...
             while(rs1.next()){
                 Family.add(rs1.getString("styfam").trim());
             }
             Po.put(rs.getString("po"), Family);
           }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PoPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PoPlan dialog = new PoPlan(new javax.swing.JFrame(), true);
    ...
    public void alerter(Object... ob) {
        obs.forEach(obse->{obse.executer(ob);});
    }
}
