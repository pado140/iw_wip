 ...
 * @author Duvers
 */
public class Sewing_prod_close_sku extends javax.swing.JInternalFrame {
    ...
    private void jDateChooser1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jDateChooser1PropertyChange
        ...
        dat=null;
        jTextField1.setEditable(false);
        if(!evt.getNewValue().toString().trim().isEmpty() && evt.getNewValue() instanceof Date){
            try{
            dat=(Date)evt.getNewValue();
            }catch(Exception e){
                System.err.println(e.getMessage());
            }
        }
        if(dat!=null){
            System.err.println("date:"+dat);
